...
export default function SignIn() {
    ...
    return (
        ...
        <div class="mx-auto my-10 max-w-md rounded-xl border px-4 py-10 text-gray-700 shadow-lg sm:px-8">
            ...
            <p class="mb-5 text-2xl font-medium">SignIn </p>
            ...
            <div class="mb-6">
                ...
                <div className="mb-4">
                    ...
                    </button><p class="text-sm font-light text-gray-700 ">
                        Create Account? <a onClick={()=>{
                            navigate("/signup")
                        }} class="font-medium text-primary-600 hover:underline dark:text-primary-500">SignUp here</a>
                    </p>
                </form>
            </div>
